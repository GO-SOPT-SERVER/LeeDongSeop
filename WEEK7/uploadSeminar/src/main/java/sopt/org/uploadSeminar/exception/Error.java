package sopt.org.uploadSeminar.exception;
...
public enum Error {
    ...
    NOT_FOUND_SAVE_IMAGE_EXCEPTION(HttpStatus.NOT_FOUND, "저장된 이미지가 없습니다"),
    NOT_FOUND_IMAGE_EXCEPTION(HttpStatus.NOT_FOUND, "업로드될 이미지가 없습니다"),
